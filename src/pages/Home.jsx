  ...
  >
    {code}
      ...
      >
        ...
        >
          Crafting <span className="font-semibold text-blue-600">exceptional digital experiences</span> with modern technologies. 
          Specializing in React.js, Next.js, and TailwindCSS to build <span className="italic">fast, accessible,</span> and <span className="italic">visually stunning</span> web applications.
        </motion.p>
