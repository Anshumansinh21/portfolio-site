...
>
  ...
  <motion.div variants={item}>
    ...
    >
      ...
      <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-4">
        While <span className="font-semibold underline decoration-blue-500">Studying at Gujarat University</span>, I took my first step into the IT world at just <span className="font-bold text-yellow-600 dark:text-yellow-400">19 years old</span>, working as a Software Support Executive at <span className="font-semibold text-blue-600 dark:text-blue-400">Height8 Technologies</span>. What started as a support role gradually evolved into a career in UI/UX design and front-end development.
      </p>
      <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-4">
